...
void SetupMatrices()
{
	...
	D3DXVECTOR3 vEyept(0.0f + g_leftRight, 3.0f + g_upDown, -5.0f + g_scale); //카메라 : 내가 어디있는지 
...
void Render()
{
	...
	if (SUCCEEDED(g_pD3DDevice->BeginScene()))
	{
		...
		g_pD3DDevice->SetTextureStageState(0, D3DTSS_COLOROP, D3DTOP_MODULATE);//연산
		g_pD3DDevice->SetTextureStageState(0, D3DTSS_COLORARG1, D3DTA_TEXTURE);//arg1
		g_pD3DDevice->SetTextureStageState(0, D3DTSS_COLORARG2, D3DTA_DIFFUSE);//arg2
