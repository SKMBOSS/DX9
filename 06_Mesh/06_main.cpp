...
HRESULT InitGeometry()
{
	...
	if (FAILED(D3DXLoadMeshFromXA("Ezreal.x", D3DXMESH_SYSTEMMEM, g_pD3DDevice, NULL, &pD3dXMtrlBuffer,
...
void SetupMatrices()
{
	...
	{
		g_leftRight -= m_fElapseTime * 30.0f;
	}
	...
	D3DXVECTOR3 vEyept(0.0f + g_leftRight, 3.0f + g_upDown, -185.0f + g_scale); //카메라 : 내가 어디있는지 
	D3DXVECTOR3 vLootatPt(0.0f + g_leftRight, 50.0f + g_upDown, 0.0f + g_scale); //카메라 : 내가 뭘볼지 어디가 
